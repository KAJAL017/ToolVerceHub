...
@section('page-subtitle', 'Add a new blog tag')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="flex items-center space-x-3">
            <button type="submit" id="submitBtn" class="px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-lg transition-colors">
                ...
                <span id="btnText">Create Tag</span>
            </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                window.location.href = '{{ route("admin.blog-tags.index") }}?success=' + encodeURIComponent(data.message || 'Tag created successfully!');
            } else if (data.errors) {
                ...
                btnText.textContent = 'Create Tag';
            }
        })
        .catch(error => {
