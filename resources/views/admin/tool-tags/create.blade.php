...
@section('title', 'Create Tool Tag')
@section('page-title', 'Create Tool Tag')
@section('page-subtitle', 'Add a new tool tag')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('{{ route("admin.tool-tags.store") }}', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .then(data => {
            if (data.success) {
                window.location.href = '{{ route("admin.tool-tags.index") }}?success=' + encodeURIComponent(data.message || 'Tag created successfully!');
            } else if (data.errors) {
