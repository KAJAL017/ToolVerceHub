...
@section('page-subtitle', 'Add a new static page')

@section('content')

<form id="pageForm" action="{{ route('admin.pages.store') }}" method="POST">
    @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="slug" id="slug" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                        placeholder="e.g., privacy-policy">
                    <p class="text-xs text-gray-500 mt-1">URL: {{ url('/') }}/<span id="slugPreview">privacy-policy</span></p>
...
document.getElementById('title').addEventListener('input', function() {
    ...
    document.getElementById('slugPreview').textContent = slug || 'page-slug';
});
...
document.getElementById('pageForm').addEventListener('submit', function(e) {
    ...
    .catch(error => {
        ...
        showToast('An error occurred while creating the page', 'error');
    });
});
</script>
@endsection
