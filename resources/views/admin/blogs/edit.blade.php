...
<form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="text" name="author_emoji" value="{{ old('author_emoji', $blog->author_emoji ?? '✍️') }}" maxlength="10"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                    placeholder="✍️">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div class="mb-4">
            ...
            <textarea id="editor-content" name="content" required class="w-full">{{ old('content', $blog->content) }}</textarea>
            @error('content')
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-3 gap-2">
                                    <input type="text" name="promo_link_text[]" value="{{ $promo['link_text'] ?? '' }}" placeholder="Try Free"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm">
                                    <input type="url" name="promo_link_url[]" value="{{ $promo['link_url'] ?? '' }}" placeholder="https://example.com"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm">
                        ...
                        <div class="quick-link-item mb-3 p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <input type="text" name="quick_link_text[]" value="{{ $link['text'] ?? '' }}" placeholder="Link Text"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm">
                                <input type="url" name="quick_link_url[]" value="{{ $link['url'] ?? '' }}" placeholder="https://example.com"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 text-sm">
        ...
        <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-3">
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="category_color" value="g" {{ old('category_color', $blog->category_color) == 'g' ? 'checked' : '' }} class="mr-2">
                                <span class="w-6 h-6 bg-green-500 rounded-full"></span>
                            </label>
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="category_color" value="c" {{ old('category_color', $blog->category_color) == 'c' ? 'checked' : '' }} class="mr-2">
                                <span class="w-6 h-6 bg-orange-500 rounded-full"></span>
                            </label>
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="category_color" value="b" {{ old('category_color', $blog->category_color) == 'b' ? 'checked' : '' }} class="mr-2">
                                <span class="w-6 h-6 bg-blue-500 rounded-full"></span>
                            </label>
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" name="category_color" value="a" {{ old('category_color', $blog->category_color) == 'a' ? 'checked' : '' }} class="mr-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title', $blog->meta_title) }}" maxlength="60"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="featured_image_emoji" value="{{ old('featured_image_emoji', $blog->featured_image_emoji) }}" maxlength="10"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
                            placeholder="🖼️">
                    </div>
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="published_date" value="{{ old('published_date', $blog->published_date->format('Y-m-d')) }}" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500">
                </div>
                ...
                <div class="text-sm text-gray-600">
                    ...
                    @if($blog->updated_date)
                        <p><strong>Last Updated:</strong> {{ $blog->updated_date->format('M d, Y') }}</p>
                    @endif
                    <p><strong>Views:</strong> {{ number_format($blog->views_count) }}</p>
                </div>
            </div>
